...
<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8"> {{-- Saya kecilkan sikit max-width untuk borang --}}
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 md:p-8 text-gray-900 dark:text-gray-100">

                    <form method="POST" action="{{ route('admin.staf.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="staff_id_number" class="block mt-1 w-full" type="text" name="staff_id_number" :value="old('staff_id_number')" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="date_joined" class="block mt-1 w-full" type="date" name="date_joined" :value="old('date_joined')" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="bank_account_number" class="block mt-1 w-full" type="text" name="bank_account_number" :value="old('bank_account_number')" />
                        ...
                        <div class="mt-4">
                            <x-input-label for="profile_image" :value="__('Muat Naik Gambar Profil')" />
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="file_input_help">PNG, JPG atau JPEG (MAX. 2MB).</p>
